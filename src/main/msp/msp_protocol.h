...
#define MSP_WIND                 167    //out message         wind speed, wind direction
#define MSP_RADAR                168    //out message         nearest POI telemetry
#define MSP_SAVECONFIG           169    //in message          save config
